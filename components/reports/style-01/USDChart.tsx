...
const USDChart = () => {
  ...
  return (
    <div className="box col-span-12 lg:col-span-6 overflow-x-hidden">
      <div className="mb-4 pb-4 xl:pb-6 xl:mb-6 bb-dashed flex justify-between items-center flex-wrap gap-4">
        <h4 className="h4">US Dollar (USD)</h4>
