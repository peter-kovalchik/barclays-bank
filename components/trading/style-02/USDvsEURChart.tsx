...
const USDvsEUChart = () => {
  ...
  return (
    <div className="col-span-12 md:col-span-7 lg:col-span-8 box overflow-x-hidden">
      <div className="flex flex-wrap justify-between items-center gap-3 pb-4 lg:pb-6 bb-dashed">
        <h4 className="h4">USD vs EUR</h4>
