  ...
  return (
    <div className="box">
      ...
      <div className="bb-dashed pb-4 mb-4 lg:mb-6 lg:pb-6 flex flex-col">
        <div
          className={`box border border-n30 dark:border-n500 bg-primary/5 dark:bg-bg3 p-3 xl:p-3 xxl:p-4 ${
        ...
        <div
          className={`box border border-n30 dark:border-n500 bg-primary/5 dark:bg-bg3 p-4 xl:p-3 xxl:p-4  ${
