...
const SelectLayout = () => {
  ...
  return (
    <div ref={ref} className="relative max-w-[232px] w-full max-sm:hidden ">
      {/* <div
        onClick={toggleOpen}
        className={`bg-primary/5 dark:bg-bg3 border border-n30 dark:border-n500 cursor-pointer w-full rounded-[30px] py-1 xxl:py-1.5 flex items-center justify-between gap-2 px-4 xxl:px-6`}>
