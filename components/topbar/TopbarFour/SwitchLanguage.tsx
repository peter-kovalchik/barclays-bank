...
const SwitchLanguage = () => {
  ...
  return (
    <div className="relative" ref={ref}>
      {/* <button
        onClick={toggleOpen}
        className={`flex gap-1 p-2 sm:p-3 rounded-full bg-n0 dark:bg-bg4 shadow-[0px_6px_40px_0px_rgba(0,0,0,0.02)]`}>
        <i className="las la-language"></i>
      </button> */}
      <div
        className={`bg-n0  dark:bg-bg4 rounded-md ltr:right-0 rtl:left-0 z-[11] ltr:origin-top-right rtl:origin-top-left shadow-[0px_6px_30px_0px_rgba(0,0,0,0.08)] absolute top-full duration-300 ${
