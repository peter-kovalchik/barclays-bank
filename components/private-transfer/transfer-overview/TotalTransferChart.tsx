...
const TotalTransferChart = () => {
  ...
  const chartData: ApexOptions = {
    ...
    xaxis: {
      type: "datetime",
      min: new Date("20 Dec 2023").getTime(),
      tickAmount: 6,
      labels: {
        style: {
  ...
  return (
    <div className="col-span-12 box overflow-x-hidden">
      <div className="flex justify-between gap-4 flex-wrap items-center bb-dashed mb-4 pb-4">
        <h4 className="h4">Total Transfer</h4>
...
export default TotalTransferChart;
